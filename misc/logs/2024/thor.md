...
* [ ] [Understanding this coe formatting CI error](https://github.com/i2mint/ju/actions/runs/11181072235/job/31084209395#step:5:93). Is it axblack, or black? See previous errors, where I couldn't install `datamodel_code_generator` just for testing.
