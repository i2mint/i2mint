...
* [ ] [CI with docs problem](https://github.com/i2mint/shaded/actions/runs/15676310658/job/44157329699#step:4:43). It seems like the gh-pages branch has the same kind of files in [shaded](https://github.com/i2mint/shaded/tree/gh-pages) and [dol](https://github.com/i2mint/dol/tree/gh-pages). The `Pages` settings also seem to be the smae for [shaded](https://github.com/i2mint/shaded/settings/pages) and [dol](https://github.com/i2mint/dol/settings/pages)
