...
* [ ] **master/main CI branch problem**. Have a look at how to (1) specify CI-triggering branch as a variable, (2) specify several, and (3) default to default branch. --> Check out https://github.com/marketplace/actions/get-the-default-branch
